#### This R script will implement our method to fit model 2.1 on brain regional volumes (Y), genotype on chromosome 6 (X), and the environmental/demographic covariates (U).
#### The output file "chr6_result.RData" includes the estimates and the clustering patterns of the estimated coefficient vectors.   
...
options(warn = 1)
load("/mnt/project/Data/X_Rdata/chr6_X.RData")
...
save(n, d, p, q, q0, Betas, Blabels, classifications, means, covariances, cluster_nums, run_time,
     file = "chr6_result.RData")

system(paste0("dx upload chr6_result.RData"))

system("dx upload ukb_chr6.R")

system("dx terminate job-J1v7530JbfG96g4qQ18zK94G")
