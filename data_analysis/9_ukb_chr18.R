...
options(warn = 1)
load("path_to/chr18_X.RData")
load("path_to/UKB_U.RData")
load("path_to/UKB_Y.RData")
...
save(n, d, p, q, Betas, Blabels, classifications, means, covariances, cluster_nums, run_time,
