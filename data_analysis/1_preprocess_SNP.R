#### This R script will preprocess the SNP data (filtering low-quality ones), preprocess the environmental factors.
#### This include removing genetically related individuals, detecting outliers, and removing entries with missing data or outliers.
#### It generated cleaned SNP data (still in binary format).

#### remove genetically dependent individuals and individuals with missing data.
...
#### preprocess the genotype: use PLINK for SNP quality control, that is, filtering SNPs with low quality
