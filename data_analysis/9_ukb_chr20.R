#### This R script will implement our method to fit model 2.1 on brain regional volumes (Y), genotype on chromosome 20 (X), and the environmental/demographic covariates (U).
#### The output file "chr20_result.RData" includes the estimates and the clustering patterns of the estimated coefficient vectors. 
