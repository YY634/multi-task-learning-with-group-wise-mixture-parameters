#### This R script will implement our method to fit model 2.1 on brain regional volumes (Y), genotype on chromosome 12 (X), and the environmental/demographic covariates (U).
#### The output file "chr12_result.RData" includes the estimates and the clustering patterns of the estimated coefficient vectors. 
...
options(warn = 1)
load("/mnt/project/Data/X_Rdata/chr12_X.RData")
...
save(n, d, p, q, q0, Betas, Blabels, classifications, means, covariances, cluster_nums, run_time,
     file = "chr12_result.RData")

system(paste0("dx upload chr12_result.RData"))

system("dx upload ukb_chr12.R")

system("dx terminate job-J1v6Zp0JbfG8PbYyyPBZV4g8")
