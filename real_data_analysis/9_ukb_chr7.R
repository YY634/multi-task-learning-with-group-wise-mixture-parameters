#### This R script will implement our method to fit model 2.1 on brain regional volumes (Y), genotype on chromosome 7 (X), and the environmental/demographic covariates (U).
#### The output file "chr7_result.RData" includes the estimates and the clustering patterns of the estimated coefficient vectors.  
...
options(warn = 1)
load("/mnt/project/Data/X_Rdata/chr7_X.RData")
...
save(n, d, p, q, q0, Betas, Blabels, classifications, means, covariances, cluster_nums, run_time,
     file = "chr7_result.RData")

system(paste0("dx upload chr7_result.RData"))

system("dx upload ukb_chr7.R")

system("dx terminate job-J1v74xjJbfG4PZ4JgBf9v131")
