#### This R script will implement our method to fit model 2.1 on brain regional volumes (Y), genotype on chromosome 10 (X), and the environmental/demographic covariates (U).
#### The output file "chr10_result.RData" includes the estimates and the clustering patterns of the estimated coefficient vectors.   
...
options(warn = 1)
load("/mnt/project/Data/X_Rdata/chr10_X.RData")
...
save(n, d, p, q, q0, Betas, Blabels, classifications, means, covariances, cluster_nums, run_time,
     file = "chr10_result.RData")

system(paste0("dx upload chr10_result.RData"))

system("dx upload ukb_chr10.R")

system("dx terminate job-J1v7478JbfG9pPfzx4yV5B7B")
