#!/usr/bin/env Rscript
#SBATCH --mem-per-cpu=4g  --time=12:00:00 --mail-type=ALL --mail-user=yisha.yao@yale.edu

#setting 3
n <- 1800;  d <- 6000;  q <- 800;  p <- 200;  del <- 0.12;  m <- 4  #m is the number of adjusting covariates
...
save(d, p, q, group_sizes, Beta, Beta_labels, Beta_cluster_num, true_means,
     ...
     file = "/gpfs/gibbs/project/zhang_heping/yy634/JASA_case/simulations/setting4.RData")
