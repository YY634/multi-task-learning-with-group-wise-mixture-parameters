###### This R scripts performs simulation study under setting 3. It will generate two files "setting3.RData" and "eval_setting3.RData"
###### The file "setting3.RData" contains the estimates of fitting Model 2.1 using our algorithm.  
###### The file "eval_setting3.RData" summarizes the five quality measurements in Figure 1.
###### Three parameters "opt_lam", "lam_0", and "lam_thred" can be modified. 


#setting 3
n <- 1800;  d <- 3500;  q <- 700;  p <- 200;  del <- 0.1714;  m <- 4  
...
save(RES,  file = "./eval_setting3.RData")
