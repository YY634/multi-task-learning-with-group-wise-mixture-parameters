...
#setting 6.   
p <- 68;  q <- 375;  n <- 2500;  d <- 3564; 
load("~/project/JASA_case/simulations/setting6.RData")
...
save(RES,  file = "/gpfs/gibbs/project/zhang_heping/yy634/JASA_case/simulations/eval_setting6.RData")
